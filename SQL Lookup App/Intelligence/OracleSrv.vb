...
Namespace Intelligence
    ...
    Public Class OracleSrv
        ...
        Public Event ResultMessage(message As String) Implements ISqlSrv.ResultMessage
        Public Event ErrorMessage(category As String, message As String) Implements ISqlSrv.ErrorMessage
        ...
        Private Sub Connect()
            ...
            'Connect to Server
            Try
                Me.Conn = New OracleConnection(Me.CS)
                Me.Conn.Open()
        ...
        Public Sub ExecuteStatement(ByVal sql As String) Implements ISqlSrv.ExecuteStatement
            ...
            Try
                ...
                oCmd = New OracleCommand(sql, Me.Conn)
        ...
        Private Sub ShowResults(ByRef oReader As OracleDataReader)
